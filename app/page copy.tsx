...
import { Briefcase, Layers3, Users, BookOpen, TrendingUp, FolderSync, ClipboardList, UserPlus, FileUser } from "lucide-react";
...
const categorias = [
  ...
  { id: "nombramiento-asistencial", label: "Nombramiento Asistencial", descripcion: "Proceso de nombramiento del personal asistencial", href: "/convocatorias/nombramiento-asistencial", icon: UserPlus },
