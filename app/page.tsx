...
const modules = [
  ...
  },
  {
    ...
    desc: "Capacitación, evaluación del desempeño, línea de carrera.",
    icon: BookOpen,
  ...
  },
  {
    ...
    desc: "Procesos, organigrama y servicios al personal.",
    icon: Users,
  ...
  },
  {
    href: "/rrhh/serums",
    title: "SERUMS",
    desc: "Información, cronogramas y requisitos del SERUMS.",
    icon: ClipboardList,
